    ...
    <div className='py-16 bg-[#F7F7F7]'>
      ...
      <div className='rounded-md border-t-8 border-b-8 shadow-lg border-[#CE4642]'>
            <form action="" className='py-8 px-5 bg-[#F7F7F7] text-[#CE4642] xs:w-full w-[450px] text-right'>
                ...
                <br />
                <input type="text"  className='w-full h-8 border-[#CE4642] border-2 text-right rounded-md' onChange={(e)=>{setName(e.target.value)}}/>
                <br />
                <br />   
                <label htmlFor="" className='text-lg'>رقم هاتفك</label>
                <br />
                <input type="text"  className='w-full h-8 border-[#CE4642] border-2 text-right rounded-md' onChange={(e)=>{setPhone(e.target.value)}}/>
                <br />
                <br />   
                <label htmlFor="" className='text-lg'>الخدمة المتعلقة</label>
                <select name="" id="" className='w-full h-8 border-[#CE4642] border-2 text-center rounded-md'  onChange={(e)=>{setId(e.target.value)}}>
                ...
                <textarea name="" id="" cols="30" rows="10" className='w-full border-[#CE4642] border-2 text-right rounded-md'  onChange={(e)=>{setDetail(e.target.value)}}></textarea>
                <br />
