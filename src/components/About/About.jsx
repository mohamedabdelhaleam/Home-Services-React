...
const About = () => {
  return (
    <div className='py-16'>
        ...
        <img src={aboutImg} width={350} height={350} alt="" srcset="" />
...
يتميز المركز باستخدام أحدث الأساليب العلمية والأجهزة الطبية في تقديم الخدمات الطبية المنزلية المختلفة، حيث نقوم بالإهتمام ومتابعة كل حالة على حدا من أجل توفير أفضل مستوى خدمة يمكن أن يحصل عليه المريض/العميل بالمنزل.</div>
            <div className='w-full flex justify-end xs:justify-center md:justify-center sm:justify-center  items-center'><Link to='/services' className='bg-[#CE4642] text-white py-3 px-8 text-xl font-semibold rounded-md'>تصفح خدماتنا</Link></div>
          </div>
